<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:94:"E:\httpd-2.4.28-Win64-VC15\Apache24\htdocs\TP5\public/../application/admin\view\admin\lst.html";i:1536169950;s:88:"E:\httpd-2.4.28-Win64-VC15\Apache24\htdocs\TP5\application\admin\view\common\header.html";i:1536941014;s:86:"E:\httpd-2.4.28-Win64-VC15\Apache24\htdocs\TP5\application\admin\view\common\left.html";i:1536935952;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>管理员用户</title>
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Admin/admin/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                        ...
                        <tbody>
                        	<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?>
                             <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('admin/edit',array('id'=>$row['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <?php if($row['id'] != 23): ?>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('admin/del',array('id'=>$row['id'])); ?>')" class="btn btn-danger btn-sm shiny">
