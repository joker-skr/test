<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"E:\httpd-2.4.28-Win64-VC15\Apache24\htdocs\TP5\public/../application/admin\view\admin\edit.html";i:1536167583;s:88:"E:\httpd-2.4.28-Win64-VC15\Apache24\htdocs\TP5\application\admin\view\common\header.html";i:1536514865;s:86:"E:\httpd-2.4.28-Win64-VC15\Apache24\htdocs\TP5\application\admin\view\common\left.html";i:1536231521;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>添加管理员</title>
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('Admin/admin/lst'); ?>">管理员管理</a>
                    </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="请输入管理员名" name="username" value="<?php echo $admins['username']; ?>" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必  填</p>
                        </div>
                        ...
                        <div class="form-group">
							...
							<p class="help-block col-sm-4 red">* 留 空 则 表 示 不 修 改 密 码</p>
                        </div>  
                        <div class="form-group">
