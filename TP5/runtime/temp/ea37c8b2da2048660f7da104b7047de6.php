<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"E:\httpd-2.4.28-Win64-VC15\Apache24\htdocs\TP5\public/../application/admin\view\article\edit.html";i:1536231269;s:88:"E:\httpd-2.4.28-Win64-VC15\Apache24\htdocs\TP5\application\admin\view\common\header.html";i:1536514865;s:86:"E:\httpd-2.4.28-Win64-VC15\Apache24\htdocs\TP5\application\admin\view\common\left.html";i:1536231521;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>添加管理员</title>
                    ...
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($articles['pic'] != ''): ?>
                                    <img src="http://localhost:8080/static/admin/images<?php echo $articles['pic']; ?>" height="50">
                                <?php else: ?>
                                    <span>暂无缩略图</span>
                                <?php endif; ?>
                            </div>
